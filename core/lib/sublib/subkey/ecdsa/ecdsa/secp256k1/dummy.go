...
import (
	_ "mytoken/token/substrate/subkey/ecdsa/ecdsa/secp256k1/libsecp256k1/include"
	_ "mytoken/token/substrate/subkey/ecdsa/ecdsa/secp256k1/libsecp256k1/src"
	_ "mytoken/token/substrate/subkey/ecdsa/ecdsa/secp256k1/libsecp256k1/src/modules/recovery"
)
