...
func (c *Client) Call(method Method, args ...interface{}) (json.RawMessage, error) {
...
// The result must be a pointer so that package json can unmarshal into it. You
// can also pass nil, in which case the result is ignored.
func (c *Client) CallContext(ctx context.Context, method Method, args ...interface{}) (json.RawMessage, error) {
